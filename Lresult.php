...
if ($totalCorrect>=18 && $totalCorrect <=20)
{
      print "Your grade is Advanced";
}
else if($totalCorrect>=15 && $totalCorrect <= 17)
{
      print "Your grade is Upper-intermediate";
}
else if($totalCorrect>12 &&$totalCorrect <= 14)
{
      print "Your grade is Intermediate";
	
}
else if($totalCorrect>=10 && $totalCorrect <= 12)
{
      print "Your grade is Pre-intermediate";
}
else if($totalCorrect>=7 && $totalCorrect < 10)
{
      print "Your grade is Elementary";
}
else{
      print "Your grade is Beginner";
}
